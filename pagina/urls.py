...
urlpatterns = [
    path('', LoginView.as_view(template_name='core/home.html',authentication_form=UserLoginForm),name='login'),
    ...
    next_page=reverse_lazy('login') # you can use your named URL here just like you use the **url** tag in your django template
), name='logout'),
